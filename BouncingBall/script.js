...
class BasicWorldDemo {
  ...
  initialize() {
    ...
    // setTimeout(()=>{
    //   this.physicsWorld_.setGravity(new Ammo.btVector3(-0.5, -100, 0));
    // },1000) 
    ...
    this.camera_ = new THREE.PerspectiveCamera(30, 1920 / 1080,2.0,1000.0);
    ...
    // dirLight.position.set( 8, 1.75, 2 );
    ...
    this.scene_.background = new THREE.Color( 0xe0dfdb );
    ...
    new THREE.BoxGeometry(1000,0.1, 1000),mat)
  ...
  // for (let x = 0; x <1; ++x) {
    ...
    var Ball1 = new THREE.Mesh(
            ...
            // Ball1.position.set( x+6, 500,y+12 );
            Ball1.position.set( 9, 100,15);
            Ball1.castShadow = true;
            Ball1.receiveShadow = true;
            this.scene_.add(Ball1);
            var rbBall1 = new RigidBody();
            // console.log(RigidBody);
            // rbBall1.rotation.z+=7;
  ...
  //   for (let y = 0; y <1; ++y) {
    const Ball2 = new THREE.Mesh(
            ...
            // rbBall2.setFriction(1); 
            // rbBall2.setRollingFriction(1);
  ...
  //   for (let y = 0; y <1; ++y) {
    var Ball3 = new THREE.Mesh(
            new THREE.SphereGeometry(10,100,100), new THREE.MeshStandardMaterial( {  map: Texture3} ))
            // new THREE.MeshStandardMaterial({color: 0xff0000}));
            Ball3.position.set(-2, 140,-10);
            // Ball3.rotation.z= 55;
            Ball3.castShadow = true;
            Ball3.receiveShadow = true;
            this.scene_.add(Ball3);
            var rbBall3 = new RigidBody();
            rbBall3.createSphere(1, Ball3.position,10);
  ...
  raf_() {
    requestAnimationFrame((t) => {
      // this.Ball3.rotation.x += 55;
      // Ball2.rotation.x= 55;
      // console.log(this.Ball1.rotation);
  ...
  step_(timeElapsed) {
    ...
    for (let i = 0; i < this.rigidBodies_.length; ++i) {
      ...
      this.rigidBodies_[2].mesh.rotation.z=-25.5
      // this.rigidBodies_[i].mesh.quaternion._w=10
